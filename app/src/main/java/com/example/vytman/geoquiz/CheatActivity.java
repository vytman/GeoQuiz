...
public class CheatActivity extends AppCompatActivity {
    ...
    private static final String EXTRA_ANSWER_IS_TRUE = "com.example.vytman.geoquiz.answer_is_true";
    private static final String EXTRA_ANSWER_SHOWN = "com.example.vytman.geoquiz.answer_shown";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCheatsRemainingTextView.setText(getString(R.string.cheats_remaining_text) + " " + mCheatsRemaining);
        mAPIlvlTextView.setText(String.format("API LVL %d", Build.VERSION.SDK_INT));
